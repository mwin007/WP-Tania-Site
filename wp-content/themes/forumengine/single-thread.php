								...
								<form class="form-post-edit" action="" method="post">
									...
									<div class="text-search">
										<div class="input-container">
											<input class="inp-title" name="post_title" maxlength="90" type="text" value="<?php echo $post->post_title ?>" placeholder="<?php _e('Click here to start your new rant' , ET_DOMAIN) ?>">
										</div>
