		...
		<div class="col-md-9 marginTop30">
			...
			<div class="side-bar infor-contact-profile" style="display:none">
				...
				<div class="contact-tablet col-3">
					...
					<p><span class="icon-phone"></span><span class="text"><?php echo esc_attr( $user_mobile ) ?></span></p>
				</div>
				<?php } ?>
				<div class="fb-tablet col-3">
					<h2 class=""><?php _e('Social Links',ET_DOMAIN) ?></h2>
					<p><a target="_blank" href="<?php echo $user_facebook ?>"><span class="icon-fb" ></span><span class="text"><?php echo esc_attr( $user_facebook ) ?></span></a></p>
					<p><a target="_blank" href="<?php echo $user_twitter ?>"><span class="icon-tw" ></span><span class="text"><?php echo esc_attr( $user_twitter ) ?></span></a></p>
					<p><a target="_blank" href="<?php echo $user_gplus ?>"><span class="icon-google" ></span><span class="text"><?php echo esc_attr( $user_gplus ) ?></span></a></p>
				</div>
